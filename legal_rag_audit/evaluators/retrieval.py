...
class RetrievalEvaluator:
    """Cosine similarity between the query and each retrieved chunk, scored locally.

    Embeddings are computed in-process. No request leaves this machine during scoring.
    """
